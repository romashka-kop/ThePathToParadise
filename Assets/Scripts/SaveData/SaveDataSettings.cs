...
public class SaveDataSettings : AbsSaveData
{
    ...
    public KeyCode[] PlayerControlKeyCode = { KeyCode.W, KeyCode.S, KeyCode.A, KeyCode.D, KeyCode.Space,KeyCode.LeftShift, KeyCode.LeftControl, KeyCode.E, KeyCode.Mouse0 };
